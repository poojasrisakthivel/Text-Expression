...
model.fit(xtrain, ytrain, epochs=1 , batch_size=32, validation_data=(xtest, ytest))
...
text_entry = tk.Entry(root, width=40, bg=entry_bg_color, fg=entry_fg_color, font=("Arial", 10))
text_entry.pack(pady=5)

# Buttons
text_button = tk.Button(root, text="Detect Text Emotion", command=detect_text_emotion, bg=button_bg_color, fg=button_fg_color, font=("Arial", 10))
text_button.pack(pady=5)

speech_button = tk.Button(root, text="Detect Speech Emotion", command=detect_speech_emotion, bg=button_bg_color, fg=button_fg_color, font=("Arial", 10))
